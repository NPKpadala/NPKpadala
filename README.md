...
> 🟡 **Partial** — Portfolio Website responding slowly · probed `2026-08-24 11:46 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-24T11:46:52Z|Portfolio Website=slow,PDFWala=up -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-24 11:46 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟡 `SLOW` `200` | `3290 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟢 `OPERATIONAL` `200` | `1590 ms` |
...
```
<sub>Synced 2026-08-24 11:46 UTC · refreshed every 6h by GitHub Actions.</sub>
