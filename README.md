...
> 🟡 **Partial** — Portfolio Website responding slowly · probed `2026-08-25 16:59 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-25T16:59:01Z|Portfolio Website=slow,PDFWala=up -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-25 16:59 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟡 `SLOW` `200` | `3239 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟢 `OPERATIONAL` `200` | `1207 ms` |
...
```
<sub>Synced 2026-08-25 16:59 UTC · refreshed every 6h by GitHub Actions.</sub>
