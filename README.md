...
> 🟡 **Partial** — Portfolio Website responding slowly · probed `2026-09-24 15:13 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-09-24T15:13:39Z|Portfolio Website=slow,PDFWala=up -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-09-24 15:13 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟡 `SLOW` `200` | `10426 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟢 `OPERATIONAL` `200` | `1300 ms` |
