...
> 🟡 **Partial** — PDFWala responding slowly · probed `2026-08-14 21:43 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-14T21:43:47Z|Portfolio Website=up,PDFWala=slow -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-14 21:43 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟢 `OPERATIONAL` `200` | `1538 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟡 `SLOW` `200` | `3782 ms` |
...
```
<sub>Synced 2026-08-14 21:43 UTC · refreshed every 6h by GitHub Actions.</sub>
