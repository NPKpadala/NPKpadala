...
> 🟡 **Partial** — PDFWala responding slowly · probed `2026-08-17 07:26 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-17T07:26:12Z|Portfolio Website=up,PDFWala=slow -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-17 07:26 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟢 `OPERATIONAL` `200` | `2712 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟡 `SLOW` `200` | `6897 ms` |
...
```
<sub>Synced 2026-08-17 07:26 UTC · refreshed every 6h by GitHub Actions.</sub>
