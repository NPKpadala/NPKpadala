...
$ npk-ops --tail activity --user NPKpadala
   ...
   3h ago  pr      NPKpadala          #2 merged
   3h ago  pr      NPKpadala          #2 opened
   3h ago  pr      NPKpadala          #1 merged
   3h ago  pr      NPKpadala          #1 opened
   3h ago  create  NPKpadala          branch claude/readme-hiring-mana…
   7d ago  create  -sudo-access-trac… branch main
   8d ago  pr      system_disk        #3 merged
   8d ago  pr      -ops-monitor       #1 merged

# stream synced 2026-08-04 21:40 UTC · refreshed every 6h by GitHub Actions
```
