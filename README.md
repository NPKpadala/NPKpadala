...
> 🟡 **Partial** — PDFWala responding slowly · probed `2026-08-20 17:49 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-20T17:49:29Z|Portfolio Website=up,PDFWala=slow -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-20 17:49 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟢 `OPERATIONAL` `200` | `1328 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟡 `SLOW` `200` | `3670 ms` |
...
```
<sub>Synced 2026-08-20 17:49 UTC · refreshed every 6h by GitHub Actions.</sub>
