...
> 🟡 **Partial** — PDFWala responding slowly · probed `2026-08-14 08:40 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-14T08:40:02Z|Portfolio Website=up,PDFWala=slow -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-14 08:40 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟢 `OPERATIONAL` `200` | `1408 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟡 `SLOW` `200` | `3351 ms` |
...
```
<sub>Synced 2026-08-14 08:40 UTC · refreshed every 6h by GitHub Actions.</sub>
