...
> 🟡 **Partial** — PDFWala responding slowly · probed `2026-08-21 23:42 UTC`
<!-- END_SECTION:banner -->
...
<!-- probe:2026-08-21T23:42:32Z|Portfolio Website=up,PDFWala=slow -->
> Probed from a GitHub Actions runner · **2/2 operational** · last check `2026-08-21 23:42 UTC`

| Service | Endpoint | Health | Latency |
|:---|:---|:---|:---|
| **Portfolio Website** | `npkpadala.com` | 🟢 `OPERATIONAL` `200` | `1578 ms` |
| **PDFWala** | `pdf.npkpadala.com/` | 🟡 `SLOW` `200` | `3288 ms` |
...
```
<sub>Synced 2026-08-21 23:42 UTC · refreshed every 6h by GitHub Actions.</sub>
